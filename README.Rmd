...
gathered_genotypes <- mutate(gathered_genotypes, hetero_homo = ifelse(values == "NA", "NA", ifelse(values == "A\\/A" || values == "T\\/T" || values == "C\\/C" || values == "G\\/G", "Homo", "Hetero")))
tail(gathered_genotypes)
```
